                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <ul class="space-y-4">
                        <li><a href="{{ route('profile.show-profile') }}"
                                class="block text-orange-600 font-semibold">Account Overview</a></li>
                        <li><a href="{{ route('profile.show-order') }}" class="block hover:text-orange-600">My Orders</a>
                        </li>
                        <li><a href="{{ route('profile.change-password') }}" class="block hover:text-orange-600">Change
                                Password</a></li>
                        <li>
            ...
            <div class="col-span-12 lg:col-span-9 ">
                <div class="bg-white shadow-lg rounded-lg p-6">
                    ...
                    <div x-show="showInfo" id="profileInfo" class="mt-4">
                        <h4 class="text-lg font-semibold text-gray-800 border-b border-gray-300 pb-2 mb-4">Your Information:
                        </h4>
                    ...
                    <div class="flex space-x-4 mt-4">
                        <button class="text-white px-4 py-2 rounded-md bg-orange-600 hover:bg-orange-500" @click="
                                    if (openProfile) {
                                        openProfile = false; 
                                        showInfo = true; 
                                    } else {
