  ...
  <div class="max-w-7xl mx-auto grid grid-cols-12 gap-6">
    ...
    <div class="col-span-12 lg:col-span-3 space-y-6">
      <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <ul class="space-y-4">
          <li><a href="{{ route('profile.show-profile') }}" class="block hover:text-orange-600">Account
              Overview</a></li>
          <li><a href="{{ route('profile.show-order') }}" class="block text-orange-600 font-semibold">My
              Orders</a></li>
    ...
    <div class="col-span-12 lg:col-span-9">
      <div class="bg-white shadow-lg rounded-lg p-6">
        ...
        <ul class="space-y-4">
          ...
          <li class="hover:bg-gray-50 border border-gray-200 rounded-md shadow-sm p-4"
            ...
            <ul class="mt-4 space-y-2" x-show="showDetails" x-collapse>
              ...
              <li class="flex justify-between bg-gray-100 p-4 rounded-md shadow-sm">
                <div class="flex items-center space-x-4">
                  ...
                  <div>
                    <span class="block font-semibold text-gray-800">{{ $detail->product->product_name }}</span>
