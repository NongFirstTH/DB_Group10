        ...
        <div class="max-w-7xl mx-auto grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 lg:col-span-3 space-y-6">
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <ul class="space-y-4">
                        <li><a href="{{ route('profile.show.profile') }}" class="block hover:text-orange-600">Account Overview</a></li>
                        <li><a href="{{ route('profile.show.orders') }}" class="block text-orange-600 font-semibold">My Orders</a></li>
                        <li><a href="{{ route('profile.show.changePassword') }}" class="block hover:text-orange-600">Change Password</a></li>
                        <li>
                                        ...
                                        @foreach ($order->orderDetails as $detail)
                                            <li class="flex justify-between bg-gray-100 p-4 rounded-md shadow-sm">
                                                <div class="flex items-center space-x-4">
                                                    <!-- Product Image -->
                                                    <img src="{{ asset('storage/' . $detail->product->image) }}" alt="Product Image" class="w-16 h-16 object-cover rounded-lg">
                                                ...
                                                <div class="text-right">
                                                    <span class="block font-semibold text-gray-700">Price: ${{ number_format($detail->total_price, 2) }}</span>
                                                </div>
                                            </li>
                                        @endforeach
                                    </ul>
