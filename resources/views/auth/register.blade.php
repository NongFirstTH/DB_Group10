      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-4">
          ...
          <x-text-input id="username"
            ...
            :value="old('username', auth()->user()->username)" type="text" name="username" :value="old('username')"
            required autofocus />
        ...
        <div class="mb-4">
          ...
          <x-text-input id="email" class="block w-full px-4 py-2 border rounded-md focus:ring focus:ring-gray-300"
