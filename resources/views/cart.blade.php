      ...
      <form action="{{route('cart.checkout')}}" method="POST">
        ...
        <div class=" bg-gray-50 rounded-xl p-6 w-full mb-8 max-lg:max-w-xl max-lg:mx-auto">
          <div class="flex items-center justify-between w-full mb-6">
            ...
            <h6 id="subtotal-amount" class="subtotal-price font-semibold text-xl leading-8 text-gray-900">
              ฿{{$subtotal}}.00
            </h6>
          </div>
          <div class="flex items-center justify-between w-full pb-6 border-b border-gray-200">
            ...
            <h6 id="discount-amount" class="discount-price font-semibold text-xl leading-8 text-gray-900">
              ฿{{$discount}}.00</h6>
          </div>
          <div class="flex items-center justify-between w-full py-6">
            <p class="font-manrope font-medium text-2xl leading-9 text-gray-900">Total</p>
            <h6 id="total-amount" class="total-price font-manrope font-medium text-2xl leading-9 text-orange-500">
              ฿{{$subtotal - $discount}}.00</h6>
          </div>
        </div>
        <div class="flex items-center flex-col sm:flex-row justify-center gap-3 mt-8">
          <!-- Checkout button -->
          <button type="submit button" id="checkout-button"
