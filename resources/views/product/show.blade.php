                        ...
                        <form action="{{ route('cart.add') }}" method="POST" class="mt-4">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <input type="number" name="quantity" id="quantity" value="0" min="0"
                                    ...
                                    class="border border-gray-300 rounded-md p-1 w-24 focus:ring-orange-400 focus:border-orange-400 transition duration-150 ease-in-out"> <!-- Added border and transition classes -->
                            </div>

                            <button type="submit" class="mt-4 bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 {{ $product->quantity == 0 ? 'opacity-50 cursor-not-allowed' : '' }}"
