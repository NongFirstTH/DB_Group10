...
<div class="flex justify-center items-center space-x-6 mt-14 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-lg max-w-xs">
            ...
            <div class="text-center p-4">
                <x-nav-link :href="route('homepage.show-product', 1)" :active="request()->is('homepage/1')">
                            Dog Food
                </x-nav-link>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg max-w-xs">
            ...
            <div class="text-center p-4">
                <x-nav-link :href="route('homepage.show-product', 2)" :active="request()->is('homepage/2')">
                            Dog Toys
                </x-nav-link>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg max-w-xs">
            ...
            <div class="text-center p-4">
                <x-nav-link :href="route('homepage.show-product', 3)" :active="request()->is('homepage/3')">
                            Dog Grooming
                </x-nav-link>
            </div>
        </div>
