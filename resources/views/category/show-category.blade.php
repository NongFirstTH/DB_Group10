<h1 class="text-5xl font-bold text-center mt-10">CATEGORIES</h1>

<div class="flex justify-center items-center space-x-6 mt-14 mb-8">
    <!-- Food Card -->
    <div class="bg-white rounded-lg shadow-lg max-w-xs transition-transform transform hover:scale-105 duration-300 ease-in-out">
        ...
        <div class="text-center p-4">
            <x-nav-link :href="route('category.show-product', 'Dog_Food')" :active="request()->is('category/Dog_Food')" class="text-lg font-semibold transition-colors duration-200">
                Dog Food
            </x-nav-link>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg max-w-xs transition-transform transform hover:scale-105 duration-300 ease-in-out">
        ...
        <div class="text-center p-4">
            <x-nav-link :href="route('category.show-product', 'Dog_Toys')" :active="request()->is('category/Dog_Toys')" class="text-lg font-semibold transition-colors duration-200">
                Dog Toys
            </x-nav-link>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg max-w-xs transition-transform transform hover:scale-105 duration-300 ease-in-out">
        ...
        <div class="text-center p-4">
            <x-nav-link :href="route('category.show-product', 'Dog_Grooming')" :active="request()->is('category/Dog_Grooming')" class="text-lg font-semibold transition-colors duration-200">
                Dog Grooming
            </x-nav-link>
        </div>
    </div>
